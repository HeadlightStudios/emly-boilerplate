...
import { Dialog, Form, Paragraph, Stack } from '@headlight/cosmos'
import { colors, misc, spacing } from '@headlight/cosmos-tokens'
import { StyledHeading } from '@headlight/cosmos/atoms/heading'
